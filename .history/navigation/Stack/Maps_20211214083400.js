...
// import Icon3 from 'react-native-vector-icons/FontAwesome5Brands';
        ...
        <View style={Styles.VoteDetail}>
          ...
          <View style={Styles.contactMaps}>
            ...
            <View style={Styles.contactSocial}>
              <View style={[Styles.contactIcon, Styles.contactIconCl1]}>
              ...
              <View style={[Styles.contactIcon, Styles.contactIconC3]}>
                <Icon name="twitter" style={Styles.iconSocial} />
              </View>
              <View style={[Styles.contactIcon, Styles.contactIconC4]}>
