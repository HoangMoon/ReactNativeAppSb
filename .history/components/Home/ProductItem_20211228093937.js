...
const ProductItem = props => {
  ...
  const [isColorHeart, setColorHeart] = useState(true);

  const handleHeart = () => {
    setColorHeart(!isColorHeart);
  };
  return (
    <>
      <View style={styles.productItem}>
        ...
        <Text style={styles.productPriceNews}>New</Text>
        <TouchableOpacity
          ...
          <Icon
            name="heart"
            size={25}
            style={[{color: isColorHeart ? '#ccc' : '#EB3349'}]}
          />
        </TouchableOpacity>
        <Pressable
        ...
        <>
          <View style={styles.productItem1}>
            ...
            <View style={styles.featurePrice}>
              <Text style={styles.productPrice}>{price}.000đ</Text>
            </View>
